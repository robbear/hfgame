...
public class UserLocationAPI {
	...
	public static void createLocation(
			...
			double accuracy, RESTHelper.RESTHelperListener listener) {
		
		if(D)Log.d(TAG, String.format(
				"UserLocationAPI.createLocation: userId=%s, longitude=%f, latitude=%f, altitude=%f, accuracy=%d",
				userId, longitude, latitude, altitude, accuracy));
