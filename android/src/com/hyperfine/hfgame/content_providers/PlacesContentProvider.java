...
public class PlacesContentProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://com.hyperfine.provider.places/places");
	...
	static {
		...
		uriMatcher.addURI("com.hyperfine.provider.places", "places", PLACES);
		uriMatcher.addURI("com.hyperfine.provider.places", "places/*", PLACE_ID);
	}
  
	@Override
	public boolean onCreate() {
		if(D)Log.d(TAG, "PlacesContentProvider.onCreate");
		...
		try {
			...
			placesDB = null;
			if(E)Log.e(TAG, "PlacesContentProvider.onCreate - exception caught opening database", e);
			e.printStackTrace();
		}
		catch (Exception e) {
			placesDB = null;
	...
	public String getType(Uri uri) {
		switch (uriMatcher.match(uri)) {
			case PLACES: return "vnd.android.cursor.dir/vnd.hyperfine.place";
			case PLACE_ID: return "vnd.android.cursor.item/vnd.hyperfine.place";
	...
	private static class PlacesDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			if(D)Log.d(TAG, "Upgrading database from version " + oldVersion + " to "
