...
public class PlaceDetailsContentProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://com.hyperfine.provider.placedetails/places");
	...
	static {
		...
		uriMatcher.addURI("com.hyperfine.provider.placedetails", "places", PLACES);
		uriMatcher.addURI("com.hyperfine.provider.placedetails", "places/*", PLACE_ID);
	}
  
	@Override
	public boolean onCreate() {
		if(D)Log.d(TAG, "PlaceDetailsContentProvider.onCreate");
		...
		try {
			...
			placesDB = null;
			if(E)Log.e(TAG, "PlaceDetailsContentProvider.onCreate - exception caught opening database", e);
			e.printStackTrace();
		}
		catch (Exception e) {
			placesDB = null;
	...
	public String getType(Uri uri) {
		switch (uriMatcher.match(uri)) {
			case PLACES: return "vnd.android.cursor.dir/vnd.hyperfine.placedetail";
			case PLACE_ID: return "vnd.android.cursor.item/vnd.hyperfine.placedetail";
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sort) {
		if(D)Log.d(TAG, "PlaceDetailsContentProvider.query");
	...
	public Uri insert(Uri _uri, ContentValues _initialValues) {
		if(D)Log.d(TAG, "PlaceDetailsContentProvider.insert");
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		if(D)Log.d(TAG, "PlaceDetailsContentProvider.delete");
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
		if(D)Log.d(TAG, "PlaceDetailsContentProvider.update");
