...
public class QueuedCheckinsContentProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://com.hyperfine.provider.checkins/checkins");
	...
	static {
		...
		uriMatcher.addURI("com.hyperfine.provider.checkins", "checkins", CHECKINS);
		uriMatcher.addURI("com.hyperfine.provider.checkins", "checkins/*", CHECKIN_ID);
	}
	...
	public boolean onCreate() {
		...
		try {
			...
			checkinsDB = null;
			if(E)Log.e(TAG, "QueuedCheckinsContentProvider.onCreate - exception caught opening database", e);
			e.printStackTrace();
		}
		catch (Exception e) {
			checkinsDB = null;
	...
	public String getType(Uri uri) {
		switch (uriMatcher.match(uri)) {
			case CHECKINS: return "vnd.android.cursor.dir/vnd.hyperfine.checkin";
			case CHECKIN_ID: return "vnd.android.cursor.item/vnd.hyperfine.checkin";
